...
class AnnualFinAnalysis:
    def __init__(self, **kwargs):
        ...
        self.analysis_fy_cash = ''
        self.analysis_fy_debt = ''
        self.analysis_fy_growth = ''
        self.analysis_fy_owner = ''
        self.analysis_fy_cost = ''
    ...
    def _analysis_data_normalization(self):
        ...
        if any(fy_df1.columns == 'balance_sheet.Cash and Cash Equivalents'):
            fy_df2['CashAndEquivalents'] = fy_df1['balance_sheet.Cash and Cash Equivalents'].astype(float)
        else:
            fy_df2 # Do Nothing
